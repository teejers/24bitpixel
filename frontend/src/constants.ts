...
/** Where the contract lives on each chain. Filled in as we deploy. */
export const DEPLOYMENTS: Record<number, Deployment> = {
  // Local Hardhat node (default first-deploy address)
  31337: {
  ...
  // Ethereum mainnet (deployed 2026-09-17)
  1: {
    address: "0x23C82346aF7E0aF1aE2f285eDf6Fe1160CCB600A",
    deployBlock: 25998892n,
